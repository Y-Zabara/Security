...
@pytest.mark.parametrize("alphabet, key, plain, encrypted", [
    ...
    ("АБВГДЕЄЖЗИIЙКЛМНОПРСТУФХЦЧШЩЬЮЯ", 5, "ПРИВІТ", "ФХНЖЧ"),
    ("АБВГДЕЄЖЗИIЙКЛМНОПРСТУФХЦЧШЩЬЮЯ", 5, "ЩОДЕННИК", "БУИЙТТНП"),
...
@pytest.mark.parametrize("alphabet, key, encrypted, plain", [
    ...
    # Кирилиця
    ("АБВГДЕЄЖЗИIЙКЛМНОПРСТУФХЦЧШЩЬЮЯ", 5, "ФХНЖЧ", "ПРИВІТ"),
    ("АБВГДЕЄЖЗИIЙКЛМНОПРСТУФХЦЧШЩЬЮЯ", 5, "БУИЙТТНП", "ЩОДЕННИК"),
